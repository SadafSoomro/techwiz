...
-- ---------------------------------------------------------------------------
-- 30. PRODUCTS  (SRS "Merchandise": Product_Id, Name, Price, Image_Url, Category)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 31. WISHLISTS  (SRS "Wishlists": Wish_Id, User_Id, Product_Id, Saved_At)
...
-- ---------------------------------------------------------------------------
-- 33. ORDERS  (simulated checkout - the SRS "bill")
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 34. ORDER ITEMS  (immutable snapshot of each ordered line)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 35. PRICE ALERTS  (price drop alerts via push notifications)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 36. AI FAN HELPER  (knowledge base + persisted conversation)
-- ---------------------------------------------------------------------------
